...
cd "$worktree"
python scripts/powerspectra/compute_l1_m9_feedback_bandpowers.py \
...
python scripts/powerspectra/compute_l2p8_m9_masked_ps_alpha_fixed_1p12.py \
  --selection qfrommap --workers 8
...
python scripts/figures/plot_l1_l2p8_m9_masked_ps_comparison.py --selection qfrommap
