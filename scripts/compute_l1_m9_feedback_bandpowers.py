...
def main() -> None:
    ...
    for variant, map_stem, cat_stem in VARIANTS:
        ...
        dl18_full = bin_planck_dl(ell, cl_full)
        ell_log, dl12_full = bin_log_dl(ell, cl_full)
        ...
        del mask_apo, ymap
        dl18_masked = bin_planck_dl(ell, cl_masked)
        _, dl12_masked = bin_log_dl(ell, cl_masked)
